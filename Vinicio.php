...
<body>
	...
	<div id="ContInicio">
			...
			<div id="slider">
				<div><img src="img/aimg1.jpg" width="900" height="200"></div>
				<div><img src="img/aimg3.jpg" width="900" height="200"></div>
				<div><img src="img/aimg2.jpg" width="900" height="200"></div>
			</div>
			<!--
			<div id="section">
				<div id="article1">
