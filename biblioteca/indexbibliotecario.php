...
<?php 
	...
	$texto = "Administrador: " .$nombre ." " .$apellidos ." | " ."Nro Carnet: " .$carnet;
...
<body onload="VistaInicio()">
	<div id="contenedor">
		...
		<header>
			...
			<div id="banner">
				<div><img src="img_l/fabanner.jpg" width="900" height="200"></div>	
			</div>
		...
		<center>
			...
			<ul id="menu">
				...
				<li><a onclick="VistaLibro();">Productos</a></li>
		...
		<footer>
			<p>Prueba | Proyecto Sistema ventas © |</p>
		</footer>
