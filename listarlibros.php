...
SELECT LI.CodLibro, LI.Titulo, LI.Portada, AU.Descripcion as Autor,GE.Descripcion as Genero , ED.Descripcion as Editorial, LI.Ubicacion, LI.Ejemplar, LI.fecha_v FROM libros LI
		...
		while ($fila = mysqli_fetch_array($resultado)) {
			echo "<tr>";
				...
				echo "<td>
					...
					<strong><p style='color:green;'>Medicamento: </p></strong>"  .$fila['Autor'] ."<br><br>
					<strong><p style='color:green;'>Clasificación: </p></strong>" .$fila['Genero'] ."<br><br>
					<strong><p style='color:green;'>Laboratorio: </p></strong>" .$fila['Editorial'];
				echo "</td>";
